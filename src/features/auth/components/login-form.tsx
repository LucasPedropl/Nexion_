  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 w-full max-w-sm">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <span className="relative bg-[#232221] px-2 text-xs text-muted-foreground uppercase">ou email</span>
      </div>
      ...
      <p className="text-sm text-center text-muted-foreground">
        Não tem uma conta? <Link href={redirectTo ? `/register?next=${encodeURIComponent(redirectTo)}` : '/register'} className="text-primary hover:underline">Cadastre-se</Link>
      </p>
    </form>
  )
}
